...
export const bdiScale: ScaleDefinition = {
  ...
  bands: sumBands([
    [0, 13, "较低", "可能无明显抑郁表现", "0～13 分通常提示可能无明显抑郁表现。", "继续关注近期情绪变化。"],
    [14, 19, "轻度", "可能有轻度抑郁表现", "14～19 分提示可能有轻度抑郁表现。", "若症状持续，建议寻求专业支持。"],
    [20, 28, "中度", "可能有中度抑郁表现", "20～28 分提示可能有中度抑郁表现。", "建议进行专业评估。"],
    [29, 63, "较高", "可能有重度抑郁表现", "29～63 分提示可能有重度抑郁表现。", "建议尽快寻求专业评估。"],
  ]),
};
